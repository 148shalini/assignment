// const htmlEditor = document.getElementById('code-content');
const copyBtn = document.getElementById('copy-btn');
const saveBtn = document.getElementById('save-btn');
const lockBtn = document.getElementById('lock-btn');

// Initialize code editor
htmlEditor.innerText = localStorage.getItem('savedCode') || htmlEditor.innerText;

// Copy button functionality
copyBtn.addEventListener('click', () => {
  const code = htmlEditor.innerText;
...
lockBtn.addEventListener('click', () => {
  htmlEditor.contentEditable = !htmlEditor.isContentEditable;
  lockBtn.classList.toggle('locked');
  if (htmlEditor.isContentEditable) {
